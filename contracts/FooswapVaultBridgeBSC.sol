...
contract FooswapVaultBridgeBSC {
    ...
    mapping(address => mapping(address => uint256)) public liquidty; // (lp => token => amount)
        ...
        external 
    {
        ...
        supportedTokens[_tokenFVM] = _tokenBSC;
...
/// supported token mapping must contain (0x2000000000000000000000000000000000000000 => file-coin token address)