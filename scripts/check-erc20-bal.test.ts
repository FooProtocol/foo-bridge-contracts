...
async function main() {
    const token = await ethers.getContractAt("FooSwapToken", "0x90118d110B07ABB82Ba8980D1c5cC96EeA810d2C", BSC_SIGNER_WALLET);

    const bal = await token.balanceOf("0xdD27c47034C20809CF7D06DcBFf22084DE4cF8A3");
    const bal_ = ethers.utils.formatEther(bal);

    console.log(bal, bal_);
}
